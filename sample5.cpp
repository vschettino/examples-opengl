...
void draw() //Render the height plot (GLUT callback function)
{
	...
	for(float x=Xmin;x<=Xmax-dx;x+=dx) //5. Render the height plot as a set of quads
	...
	glutSwapBuffers(); //6. Rendering ready, ask GLUT to show the back buffer
}
...
int main(int argc,char* argv[])	//Main program
{
   ...
   glutCreateWindow("5. Adding the domain grid"); //4. Create our window
